...
CF = -g -march=$(ISA) -mabi=$(ABI) -mcmodel=medany -fno-builtin -ffunction-sections -fdata-sections -nostartfiles -nostdlib -nostdinc -static -lgcc -Wl,--nmagic -Wl,--gc-sections -Werror -Wall 
...
debug: all
	...
	@qemu-system-riscv64 -nographic -machine virt -kernel vmlinux -bios default -S -gdb tcp::1122
